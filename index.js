...
bot.start(async (ctx) => {
  ...
  if (notJoined.length > 0) {
    return ctx.reply(
`👋 Halo! Selamat datang di LISYA BOT

Sebelum menggunakan bot ini, silahkan join 4 channel wajib terlebih dahulu:

1️⃣ Business Work All Countries
2️⃣ Lisya Store Jasa B
3️⃣ Freelance Job Indonesian
4️⃣ Loker Medan Info

Klik tombol di bawah untuk join, lalu klik ✅ Saya Sudah Join.`,
      {
        parse_mode: "HTML",
        disable_web_page_preview: true,
        ...Markup.inlineKeyboard([
          [Markup.button.url("1️⃣ Business Work All Countries", "https://t.me/bussinesworkallcountries")],
          [Markup.button.url("2️⃣ Lisya Store Jasa B", "https://t.me/lisyastorejaseb")],
          [Markup.button.url("3️⃣ Freelance Job Indonesian", "https://t.me/freelancejobindonesian")],
          [Markup.button.url("4️⃣ Loker Medan Info", "https://t.me/Lokermedaninfoo")],
